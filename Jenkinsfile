pipeline{
    ...
    stages {
        ...
        stage('OWASP FS SCAN') {
            steps {
                dependencyCheck additionalArguments: '--scan ./ --disableYarnAudit --disableNodeAudit --nvdApiKey d5133515-5b64-4200-a7bd-c800693520f8', odcInstallation: 'DC'
    ...
    always {
        script {
            ...
            emailext (
                ...
                """,
                to: 'raj959988@gmail.com',
                from: 'raj959988@gmail.com',
                replyTo: 'raj959988@gmail.com',
                mimeType: 'text/html',
